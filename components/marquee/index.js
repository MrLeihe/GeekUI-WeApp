...
Component({
  ...
  methods: {
    ...
    _init: function _init() {
      ...
      wx.createSelectorQuery().in(this).select('.geek-noticebar__content').boundingClientRect(function (rect) {
        if (!rect || !rect.width) {
        ...
        wx.createSelectorQuery().in(_this).select('.geek-noticebar__content-wrap').boundingClientRect(function (rect) {
          if (!rect || !rect.width) {
            return;
          }
